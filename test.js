...
async function run() {
  try {
    ...
    const selectedClassCollection = await client.db("sportsZone").collection("selectedClasses");
    ...
    app.get("/payments/enrolled/instructor", verifyJWT, verifyAdmin, async (req, res) => {
      const email = req.query.email;
